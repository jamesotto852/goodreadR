...
I have also developed a [**shiny**](https://shiny.rstudio.com/) app which makes use of this package,
communicating various statistics about a user's goodreads data---see it in action [here](https://jamesotto.app/Goodreads-Dashboard)
